...
vlist = [key.upper() for key in dict if dict[key] < 5000]
print(vlist)


## Find all the numbers from 1 to 1000 that have a 4 in them

num4 = [i for i in range(1000) if str(i).__contains__("4")]
print(num4)


## count how many times the word 'the' appears in the text file - 'sometext.txt'
myf = open("sometext.txt", "r")
text = myf.read()
words = text.split()

thelist = [words.count("the")]
print(thelist)
...
pdigits = [i for i in pwords if i.isdigit() == True]
print(pdigits)
